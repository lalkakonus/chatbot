...
def filterPair(pair):
    ...
    return len(pair[0].split()) < MAX_SENTENCE_LENGTH and len(pair[1].split()) < MAX_SENTENCE_LENGTH
...
def loadPreprocessedData(corpus_name, datafile):
...
def buildVocabulary(corpus_name, pairs):
